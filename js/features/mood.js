...
function updateDualMoodStats(stats) {
    ...
    const pName = (typeof settings !== 'undefined' && settings.partnerName) ? settings.partnerName : '沈星回';
...
function openMoodSelector(dateStr, editTarget) {
    ...
    if (weatherLabel) {
        var pNameW = (typeof settings !== 'undefined' && settings.partnerName) ? settings.partnerName : '沈星回';
